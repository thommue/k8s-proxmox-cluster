...
from ._setup_utils import conf_sysctl, turnoff_swap, install_containerd, configure_containerd, install_kube_pkgs
...
class PreconfigureCluster:
    ...
    def preconfigure_vms(
        ...
        for vm in self.vm_infos:
            ...
            # update
            update_upgrade_cmd(client=client_connection, upgrade=False, logger=self.logger)
            ...
            install_kube_pkgs(client=client_connection, logger=self.logger, kube_version=self.kube_version)
